...
def test_schema_has_required_columns():
    expected = {
        ...
        "mask_area_ratio", "mask_iou_score", "lab_delta_e", "lab_delta_e_p80",
        "boundary_sharpness",
        "subject_sharpness", "top10pct_lap_mask", "edge_density_mask_vs_bg",
        "predicted_mask_blur_unusable_p", "predicted_mask_blur_unusable_unreliable",
...
def test_detection_row_to_pyarrow_record_minimal():
    row = DetectionRow(
        ...
        lab_delta_e=22.5, lab_delta_e_p80=28.0, boundary_sharpness=18.4,
        subject_sharpness=210.0, top10pct_lap_mask=300.0, edge_density_mask_vs_bg=2.0,
        bbox_min_edge_px=600.0, bbox_long_edge_px=1100.0, bbox_touches_edge=False,
...
def test_schema_round_trip_in_memory():
    rows = [
        DetectionRow(
            ...
            lab_delta_e=None, lab_delta_e_p80=None, boundary_sharpness=None,
            subject_sharpness=None, top10pct_lap_mask=None, edge_density_mask_vs_bg=None,
...
def test_detection_row_phase2_round_trip():
    ...
    row = DetectionRow(
        ...
        lab_delta_e=18.5, lab_delta_e_p80=25.0, boundary_sharpness=14.2,
        subject_sharpness=195.0, top10pct_lap_mask=280.0, edge_density_mask_vs_bg=1.8,
        bbox_min_edge_px=400.0, bbox_long_edge_px=800.0,
